...
image = (
    ...
    .run_commands("pip install -U torch torchvision torchaudio xformers transformers huggingface_hub accelerate")
    .pip_install("gradio-client", "opencv-python", "sentencepiece", "protobuf", "imageio-ffmpeg")
