...
image = (
    ...
    .run_commands("pip install -U torch torchvision torchaudio xformers")
    .pip_install("gradio-client", "huggingface_hub", "accelerate", "opencv-python", "transformers", "sentencepiece", "protobuf", "imageio-ffmpeg")
