...
Respond in JSON only: {{"score": 7, "reason": "short explanation"}}
...
═══════════════════════════════════════════
STEP 3 — VISUALS (B-ROLL SEARCH QUERIES)
═══════════════════════════════════════════
Our visual engine downloads images and videos to match the script.
